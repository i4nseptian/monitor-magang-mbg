<x-filament-widgets::widget>
    <x-filament::section>
        ...
        @else
            <div class="max-h-[400px] space-y-2 overflow-y-auto pr-1 scrollbar-thin">
                @foreach ($activities as $activity)
                    <div class="flex items-start gap-3 rounded-xl border border-gray-100 p-3 shadow-sm transition hover:border-gray-200 hover:bg-gray-50 dark:border-gray-800 dark:hover:border-gray-700 dark:hover:bg-gray-900/40">
                        ...
                        <div class="min-w-0 flex-1">
                            <div class="flex flex-col gap-1.5 sm:flex-row sm:items-start sm:justify-between">
                                    ...
                                    <div class="mt-1 flex flex-wrap items-center gap-1.5">
                                        @if (!$is_mahasiswa && $activity->user)
                                            <span class="inline-flex items-center gap-1 rounded-md bg-gray-100 px-2 py-0.5 text-[11px] font-medium text-gray-600 dark:bg-gray-800 dark:text-gray-400">
                                                <svg class="h-3 w-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                                                {{ $activity->user->name }}
                                            </span>
                                        @endif
                                ...
                                <span class="shrink-0 self-start rounded-md bg-gray-50 px-2.5 py-1 text-[11px] font-semibold tabular-nums text-gray-600 dark:bg-gray-800 dark:text-gray-400">
